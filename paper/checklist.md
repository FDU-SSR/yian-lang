...
- [x] 回归：241/241、83/83、27/27、76/76。
- [x] 重测 14×3：CPU 4，warmup 1，正式样本 5，三态紧邻。
- [x] 重测 C plain/C ASan/SecL check：43 条有效腿，每腿 5 个样本。
- [x] 同步 paper/data 冻结快照。

## 图表

- [x] 用新数据生成三态成本分解 PDF，并核对 14 行断言。
