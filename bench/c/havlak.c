// bench/c/havlak.c — Havlak 循环识别 (AWFY 宏基准) 的 C 参考实现
//
// 语义与规模与 bench/shootout/havlak.an 对齐 (INNER_ITERATIONS=1, ITER=2);
...
// 规模与 bench/shootout/havlak.an 对齐: INNER=1 (上游官方断言值), ITER 轮
